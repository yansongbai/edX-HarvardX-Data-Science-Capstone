...
ChiMerge <- function(df,col,target,max_interval=5,special_attribute=NULL,minBinPcnt=0,numOfSplit=100){
  ...
  if(N_distinct<=max_interval){ 
    ...
    #step 1£ºThe data sets are grouped by col, and the total number of samples and the number of bad samples in each group are calculated
    ...
    # #step2£¬Establish a cycle to continuously merge the best two adjacent groups until£º
